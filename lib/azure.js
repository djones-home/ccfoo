...
async function show({program,subject,config,...rest}) { return "YTBD"}
async function launch({program,subject,config,...rest}) { return "YTBD"}
async function stop({program,subject,config,...rest}) { return "YTBD"}
async function start({program,subject,config,...rest}) { return "YTBD"}
async function terminate({program,subject,config,...rest}) { return "YTBD"}
