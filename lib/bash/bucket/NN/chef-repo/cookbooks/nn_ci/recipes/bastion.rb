...
#  ### A recipe to provision a bastion InstanceRole
#
# You should replace this a with useful description of how a __bastion__ is provisioned.
# 
# Workflow: 
# 
#  - Interesting step
