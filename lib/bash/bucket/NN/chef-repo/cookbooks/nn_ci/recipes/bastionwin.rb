...
#  ### A recipe to provision a bastionwin InstanceRole
#
# You should replace this a with useful description of how a __bastionwin__ is provisioned.
# 
# Workflow: 
# 
#  - Interesting step
